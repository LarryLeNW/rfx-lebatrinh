...
export default function BestRecommend() {
    ...
    return (
        <div className="relative h-[750px]">
            <div className="absolute top-0 left-0 w-full h-[470px] bg-cover bg-center bg-no-repeat bg-[url('/best-recommend/bg.png')]" />
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {getVisibleDestinations().map((destination, index) => (
                                ...
                                >
                                    <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 bg-white group p-0">
